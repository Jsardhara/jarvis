...
from .scholar.agent import Scholar
from .tempo.agent import Tempo
from .tempo.stack import build_default_tempo_stack
...
def build_default_registry() -> dict[str, AgentDescriptor]:
    ...
    try:
        from .forge.runner import WorktreeRunner as RealWorktreeRunner
